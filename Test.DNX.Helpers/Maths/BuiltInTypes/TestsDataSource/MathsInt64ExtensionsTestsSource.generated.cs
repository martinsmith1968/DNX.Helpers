...
namespace Test.DNX.Helpers.Maths.BuiltInTypes.TestsDataSource
{
    ...
    public class MathsInt64ExtensionsTestsSource
    {
        ...
        public static IEnumerable<TestCaseData> ValuesToHexString
        {
            get
            {
                yield return new TestCaseData(new [] { CreateDataValue(1) }.Cast<long>().ToArray()).Returns("01");
                yield return new TestCaseData(new [] { CreateDataValue(1), CreateDataValue(10) }.Cast<long>().ToArray()).Returns("010A");
                yield return new TestCaseData(new [] { CreateDataValue(1), CreateDataValue(10), CreateDataValue(16) }.Cast<long>().ToArray()).Returns("010A10");
                yield return new TestCaseData(new [] { CreateDataValue(16), CreateDataValue(32), CreateDataValue(64) }.Cast<long>().ToArray()).Returns("102040");
                yield return new TestCaseData(new [] { CreateDataValue(127), CreateDataValue(10) }.Cast<long>().ToArray()).Returns("7F0A");
            }
        }
    }
}
